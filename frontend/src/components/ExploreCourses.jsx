  ...
  return (
    <div className='w-[100vw] min-h-[50vh] lg:h-[50vh] flex flex-col lg:flex-row items-center justify-center gap-4 px-[30px]'>
        <div className='w-[100%] lg:w-[350px] lg:h-[100%] h-[400px]  flex flex-col items-start justify-center gap-1 md:px-[40px]  px-[20px]'>
          ...
          <p className='text-[17px]'>Our courses are designed by industry experts with a focus on practical learning, real projects, and career-oriented skills. With step-by-step guidance, hands-on assignments, and lifetime access to content, you’ll gain the confidence to build, deploy, and grow as a developer</p>
